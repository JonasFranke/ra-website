    ...
    <section className="md:min-h-screen sm:h-min bg-white dark:bg-slate-800 dark:text-gray-200">
      <div className="md:flex md:flex-row p-10 py-20">
        ...
        <div className="md:basis-1/2">
          ...
          <br />
          <p className="text-balance">
            Ich biete Ihnen eine große Stoffauswahl namhafter Hersteller an.
            Daraus fertige ich maßgeschneiderte Raffrollos, Dekoschals und
            Stores sowie Polster- und Sofakissen nach ihren Wünschen an.
          </p>
          <br />
          ...
          <p className="text-balance">
            ...
            Schritt ein verbindliches Angebot. Nach Auftragserteilung und
            fachgerechter Anfertigung in meinen Nähatelier, vereinbaren wir
