    ...
    <>
      ...
      <section className="flex flex-col gap-4 px-20 m-4">
        ...
        <div>
          ...
          <p>
            Umsatzsteuer-Identifikationsnummer gemäß § 27a UStG: DE 31 61 76 70
            9
          </p>
        </div>

        <p>Mitglied der Handwerkskammer Bremen</p>

        <h2 className="font-bold mt-3">Haftungsausschluss</h2>
